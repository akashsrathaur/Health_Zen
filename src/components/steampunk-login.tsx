  ...
  return (
    <div className="relative w-full aspect-square bg-white border-2 border-black p-4 md:p-8 font-mono text-black">
      ...
      <svg viewBox="0 0 400 400" className="w-full h-full">
        ...
        {/* Gear system */}
        <g id="gear-system" transform-origin="center" className={isSubmitting ? 'animate-spin-slow' : ''}>
           {/* Big Gear */}
        ...
        <g id="input-gear" transform-origin="255 60" className={isSubmitting ? 'animate-spin-fast-reverse' : ''}>
        ...
        <g id="middle-gear" transform-origin="275 100" className={isSubmitting ? 'animate-spin-fast' : ''}>
